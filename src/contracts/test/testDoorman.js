...
contract('doorman', accounts => {
    ...
    it(`alice stake 100 MVK tokens`, async () => {
        try{
            ...
            console.log("After Doorman Alice Record: " + afterDoormanAliceStakeRecord.amount + " " + afterDoormanAliceStakeRecord.opType + " with " + afterDoormanAliceStakeRecord.fee + " fee at " + afterDoormanAliceStakeRecord.time); // return "100000000 stake at 2021-10-26T10:14:54.000Z"
            console.log("-- -- -- -- -- -- -- -- -- -- -- -- --") // break
    ...
    it(`alice unstake 100 vMVK tokens`, async () => {
        try{
            ...
            console.log("After Doorman Alice Record: " + afterDoormanAliceStakeRecord.amount + " " + afterDoormanAliceStakeRecord.opType + " with " + afterDoormanAliceStakeRecord.fee + " fee at " + afterDoormanAliceStakeRecord.time); // return "100000000 unstake with 8330000 fee at 2021-10-26T10:14:54.000Z"
            console.log("-- -- -- -- -- -- -- -- -- -- -- -- --") // break
