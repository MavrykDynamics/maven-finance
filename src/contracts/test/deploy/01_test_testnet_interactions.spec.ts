...
describe("Testnet interactions helper", async () => {
    ...
    describe("COUNCIL", async () => {
        ...
        it('Admin adds a new vestee', async () => {
            try{
                // Operation
                const operation = await councilInstance.methods.councilActionAddVestee(bob.pkh, new BigNumber(MVK(1000000000)), 0, 24).send()
                await operation.confirmation();
            } catch(e){
                console.dir(e, {depth: 5})
            }
        ...
        it('Admin removes a vestee', async () => {
            try{
                // Operation
                const operation = await councilInstance.methods.councilActionRemoveVestee(alice.pkh).send()
                await operation.confirmation();
            } catch(e){
                console.dir(e, {depth: 5})
            }
        ...
        it('Admin locks a vestee', async () => {
            try{
                // Operation
                const operation = await councilInstance.methods.councilActionToggleVesteeLock(alice.pkh).send()
                await operation.confirmation();
            } catch(e){
                console.dir(e, {depth: 5})
            }
    ...
    describe("FARM", async () => {
        ...
        it('Admin updates blocks per minute', async () => {
            try{
                // Operation
                const operation = await farmInstance.methods.updateBlocksPerMinute(3).send()
                await operation.confirmation();
            } catch(e){
                console.dir(e, {depth: 5})
            }
