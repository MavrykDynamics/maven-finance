...
describe('Contracts Deployment for Tests', async () => {
  ...
  before('setup', async () => {
    ...
    await signerFactory(bob.sk);
      ...
      .withContractCall(treasury.contract.methods.setLambda("lambdaTransfer"                               , treasuryLambdas[9]))  // transfer
      .withContractCall(treasury.contract.methods.setLambda("lambdaMintMvkAndTransfer"                     , treasuryLambdas[10]))  // mintMvkAndTransfer
