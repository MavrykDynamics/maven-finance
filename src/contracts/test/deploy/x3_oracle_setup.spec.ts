    ...
    before('setup', async () => {
        try{
            ...
            if(utils.network != "development"){
                ...
                const queenUsdMetadata = Buffer.from(
                    JSON.stringify({
                        name: 'QUEEN/USD Aggregator Contract',
                        icon: 'https://cloudflare-ipfs.com/ipfs/QmdkDb6KnboFNknuyK72eFdM1qKgetYZegBoQkcjDYhG5k',
                        version: 'v1.0.0',
                        authors: ['Equiteez <info@mavryk.io>'],
                        category: 'rwa'
                ...
                const ntbmUsdMetadata = Buffer.from(
                    JSON.stringify({
                        name: 'NTBM/USD Aggregator Contract',
                        icon: 'https://cloudflare-ipfs.com/ipfs/QmdkDb6KnboFNknuyK72eFdM1qKgetYZegBoQkcjDYhG5k',
                        version: 'v1.0.0',
                        authors: ['Equiteez <info@mavryk.io>'],
                        category: 'rwa'
                ...
                const createAggregatorsBatch = await utils.tezos.wallet
                    ...
                    .withContractCall(aggregatorFactoryInstance.methods.createAggregator(
                        ...
                        queenUsdMetadata               // metadata bytes
                    ...
                    .withContractCall(aggregatorFactoryInstance.methods.createAggregator(
                        ...
                        ntbmUsdMetadata               // metadata bytes
