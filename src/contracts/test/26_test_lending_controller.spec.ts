...
describe("Lending Controller tests", async () => {
    ...
    describe('test paused loan token', function () {
        ...
        it('user should not be able to add liqudity if loan token is paused', async () => {
        ...
        it('user should be able to remove liqudity even if loan token is paused', async () => {
        ...
        it('user should be able to deposit into vault even if loan token is paused', async () => {
