...
describe("Mavryk Tokens tests", async () => {
    var utils: Utils;
    ...
    before("setup", async () => {
        try{
            ...
            console.log('-- -- -- -- -- Mavryk Tokens Tests -- -- -- --')
        ...
        describe("%setGovernance", async () => {
            ...
            it('Admin should be able to update the contract governance address with a new address', async () => {
                try{
                    ...
                    const resetGovernanceOperation  = await mavrykFa12TokenInstance.methods.setGovernance(governanceAddress.address).send();
        ...
        describe("%setGovernance", async () => {
            ...
            it('Admin should be able to update the contract governance address with a new address', async () => {
                try{
                    ...
                    // reset governanceAddress
                    const resetGovernanceOperation  = await mavrykFa2TokenInstance.methods.setGovernance(governanceAddress.address).send();
                    await resetGovernanceOperation.confirmation();
