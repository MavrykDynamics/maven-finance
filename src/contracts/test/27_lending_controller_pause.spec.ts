...
//                     assert.equal(updatedMockFa2LoanToken.mTokenContractAddress  , mTokenContractAddress);
//                     assert.equal(updatedMockFa2LoanToken.mTokenId               , 0);
...
//                 const mTokenContractAddress                = mTokenPoolMockFa2TokenAddress.address;
//                 const mTokenId                             = 0;
