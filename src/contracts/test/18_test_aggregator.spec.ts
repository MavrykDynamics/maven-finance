...
//                 const oraclePublicKey   = susie.pk;
//                 const oraclePeerId      = susie.peerId;
    
//                 // Operation
//                 await chai.expect(aggregatorInstance.methods.addOracle(oracleAddress, oraclePublicKey, oraclePeerId).send()).to.be.rejected;
//             } catch(e){
...
//                 // Operation
//                 const operation         = await aggregatorInstance.methods.addOracle(oracleAddress, oraclePublicKey, oraclePeerId).send();
