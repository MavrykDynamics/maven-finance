...
import { bob, alice, eve, mallory, trudy, susie, oscar } from "../../scripts/sandbox/accounts";
...
describe("Testnet interactions helper", async () => {
    ...
    before("setup", async () => {
        try{
            ...
            // councilInstance                         = await utils.tezos.contract.at("KT1B5VZPJ2AMdFBAu4BrqAskRAuzSyghQz4y");
    ...
    describe("MVN Faucet", async () => {
        ...
        it('Admin sets the real admin of the contract', async () => {
            try{
                // Operation
                var operation             = await mvnFaucetInstance.methods.setAdmin("mv1HNa3DzEiArMbdgRQHQr9HW9e6y7oZWLbB").send();
    ...
    //     });
        ...
        //             "KT1JH4GKW1taPoYkabYFmhkxtiXK7Yk75dPG",
        //             "KT1VFNE3q6zt32wqr74SbqZXiRQZgdzkUbky",
        //             MVN(2000000),
        //             "For the faucet."
        //         ).send()
        //         await operation.confirmation();
        ...
        //     try{
        //         // Operation
        //         const requestToVote         = 3
        //         await helperFunctions.signerFactory(tezos, eve.sk);
        //         let operation             = await governanceFinancialInstance.methods.voteForRequest(requestToVote, "yay").send()
        //         await helperFunctions.signerFactory(tezos, alice.sk);
        //         operation             = await governanceFinancialInstance.methods.voteForRequest(requestToVote, "yay").send()
