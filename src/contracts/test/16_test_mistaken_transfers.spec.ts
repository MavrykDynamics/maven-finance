...
//                 // Initial values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 var contractAccount         = await mavrykFa12TokenStorage.ledger.get(doormanAddress.address)
...
//                 // Mistake Operation
//                 const transferOperation     = await mavrykFa12TokenInstance.methods.transfer(bob.pkh, doormanAddress.address, tokenAmount).send();
//                 await transferOperation.confirmation();

//                 // Mid values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 contractAccount             = await mavrykFa12TokenStorage.ledger.get(doormanAddress.address)
...
//                 // Mistake Operation
//                 const transferOperation     = await mavrykFa12TokenInstance.methods.transfer(bob.pkh, farmAddress.address, tokenAmount).send();
//                 await transferOperation.confirmation();
...
//                 // Initial values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 var contractAccount         = await mavrykFa12TokenStorage.ledger.get(delegationAddress.address)
//                 var userAccount             = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
...
//                 // Mistake Operation
//                 const transferOperation     = await mavrykFa12TokenInstance.methods.transfer(bob.pkh, delegationAddress.address, tokenAmount).send();
//                 await transferOperation.confirmation();

//                 // Mid values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 contractAccount             = await mavrykFa12TokenStorage.ledger.get(delegationAddress.address)
//                 userAccount                 = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
...
//                 // Initial values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 var contractAccount         = await mavrykFa12TokenStorage.ledger.get(breakGlassAddress.address)
//                 var userAccount             = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
//                 const initAccountBalance    = contractAccount ? contractAccount.balance.toNumber() : 0;
//                 const initUserBalance       = userAccount ? userAccount.balance.toNumber() : 0;
//                 const tokenAmount           = 200;
...
//                 // Mistake Operation
//                 const transferOperation     = await mavrykFa12TokenInstance.methods.transfer(bob.pkh, breakGlassAddress.address, tokenAmount).send();
//                 await transferOperation.confirmation();

//                 // Mid values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 contractAccount             = await mavrykFa12TokenStorage.ledger.get(breakGlassAddress.address)
//                 userAccount                 = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
//                 const midAccountBalance     = contractAccount ? contractAccount.balance.toNumber() : 0;
...
//                 // Initial values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 var contractAccount         = await mavrykFa12TokenStorage.ledger.get(emergencyGovernanceAddress.address)
//                 var userAccount             = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
//                 const initAccountBalance    = contractAccount ? contractAccount.balance.toNumber() : 0;
//                 const initUserBalance       = userAccount ? userAccount.balance.toNumber() : 0;
//                 const tokenAmount           = 200;
...
//                 // Mistake Operation
//                 const transferOperation     = await mavrykFa12TokenInstance.methods.transfer(bob.pkh, emergencyGovernanceAddress.address, tokenAmount).send();
//                 await transferOperation.confirmation();

//                 // Mid values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 contractAccount             = await mavrykFa12TokenStorage.ledger.get(emergencyGovernanceAddress.address)
//                 userAccount                 = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
//                 const midAccountBalance     = contractAccount ? contractAccount.balance.toNumber() : 0;
...
//                 // Initial values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 var contractAccount         = await mavrykFa12TokenStorage.ledger.get(farmFactoryAddress.address)
//                 var userAccount             = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
//                 const initAccountBalance    = contractAccount ? contractAccount.balance.toNumber() : 0;
//                 const initUserBalance       = userAccount ? userAccount.balance.toNumber() : 0;
//                 const tokenAmount           = 200;
...
//                 // Mistake Operation
//                 const transferOperation     = await mavrykFa12TokenInstance.methods.transfer(bob.pkh, farmFactoryAddress.address, tokenAmount).send();
//                 await transferOperation.confirmation();

//                 // Mid values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 contractAccount             = await mavrykFa12TokenStorage.ledger.get(farmFactoryAddress.address)
//                 userAccount                 = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
//                 const midAccountBalance     = contractAccount ? contractAccount.balance.toNumber() : 0;
...
//                 // Initial values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 var contractAccount         = await mavrykFa12TokenStorage.ledger.get(governanceAddress.address)
//                 var userAccount             = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
//                 const initAccountBalance    = contractAccount ? contractAccount.balance.toNumber() : 0;
//                 const initUserBalance       = userAccount ? userAccount.balance.toNumber() : 0;
//                 const tokenAmount           = 200;
...
//                 // Mistake Operation
//                 const transferOperation     = await mavrykFa12TokenInstance.methods.transfer(bob.pkh, governanceAddress.address, tokenAmount).send();
//                 await transferOperation.confirmation();

//                 // Mid values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 contractAccount             = await mavrykFa12TokenStorage.ledger.get(governanceAddress.address)
//                 userAccount                 = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
//                 const midAccountBalance     = contractAccount ? contractAccount.balance.toNumber() : 0;
...
//                 // Initial values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 var contractAccount         = await mavrykFa12TokenStorage.ledger.get(governanceFinancialAddress.address)
//                 var userAccount             = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
//                 const initAccountBalance    = contractAccount ? contractAccount.balance.toNumber() : 0;
//                 const initUserBalance       = userAccount ? userAccount.balance.toNumber() : 0;
//                 const tokenAmount           = 200;
...
//                 // Mistake Operation
//                 const transferOperation     = await mavrykFa12TokenInstance.methods.transfer(bob.pkh, governanceFinancialAddress.address, tokenAmount).send();
//                 await transferOperation.confirmation();

//                 // Mid values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 contractAccount             = await mavrykFa12TokenStorage.ledger.get(governanceFinancialAddress.address)
//                 userAccount                 = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
//                 const midAccountBalance     = contractAccount ? contractAccount.balance.toNumber() : 0;
...
//                 // Initial values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 var contractAccount         = await mavrykFa12TokenStorage.ledger.get(governanceProxyAddress.address)
//                 var userAccount             = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
//                 const initAccountBalance    = contractAccount ? contractAccount.balance.toNumber() : 0;
//                 const initUserBalance       = userAccount ? userAccount.balance.toNumber() : 0;
//                 const tokenAmount           = 200;
...
//                 // Mistake Operation
//                 const transferOperation     = await mavrykFa12TokenInstance.methods.transfer(bob.pkh, governanceProxyAddress.address, tokenAmount).send();
//                 await transferOperation.confirmation();

//                 // Mid values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 contractAccount             = await mavrykFa12TokenStorage.ledger.get(governanceProxyAddress.address)
//                 userAccount                 = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
//                 const midAccountBalance     = contractAccount ? contractAccount.balance.toNumber() : 0;
...
//                 // Initial values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 var contractAccount         = await mavrykFa12TokenStorage.ledger.get(mvkTokenAddress.address)
//                 var userAccount             = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
//                 const initAccountBalance    = contractAccount ? contractAccount.balance.toNumber() : 0;
//                 const initUserBalance       = userAccount ? userAccount.balance.toNumber() : 0;
//                 const tokenAmount           = 200;
...
//                 // Mistake Operation
//                 const transferOperation     = await mavrykFa12TokenInstance.methods.transfer(bob.pkh, mvkTokenAddress.address, tokenAmount).send();
//                 await transferOperation.confirmation();

//                 // Mid values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 contractAccount             = await mavrykFa12TokenStorage.ledger.get(mvkTokenAddress.address)
//                 userAccount                 = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
//                 const midAccountBalance     = contractAccount ? contractAccount.balance.toNumber() : 0;
...
//                 // Initial values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 var contractAccount         = await mavrykFa12TokenStorage.ledger.get(treasuryFactoryAddress.address)
//                 var userAccount             = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
//                 const initAccountBalance    = contractAccount ? contractAccount.balance.toNumber() : 0;
//                 const initUserBalance       = userAccount ? userAccount.balance.toNumber() : 0;
//                 const tokenAmount           = 200;
...
//                 // Mistake Operation
//                 const transferOperation     = await mavrykFa12TokenInstance.methods.transfer(bob.pkh, treasuryFactoryAddress.address, tokenAmount).send();
//                 await transferOperation.confirmation();

//                 // Mid values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 contractAccount             = await mavrykFa12TokenStorage.ledger.get(treasuryFactoryAddress.address)
//                 userAccount                 = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
//                 const midAccountBalance     = contractAccount ? contractAccount.balance.toNumber() : 0;
...
//                 // Initial values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 var contractAccount         = await mavrykFa12TokenStorage.ledger.get(vestingAddress.address)
//                 var userAccount             = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
//                 const initAccountBalance    = contractAccount ? contractAccount.balance.toNumber() : 0;
//                 const initUserBalance       = userAccount ? userAccount.balance.toNumber() : 0;
//                 const tokenAmount           = 200;
...
//                 // Mistake Operation
//                 const transferOperation     = await mavrykFa12TokenInstance.methods.transfer(bob.pkh, vestingAddress.address, tokenAmount).send();
//                 await transferOperation.confirmation();

//                 // Mid values
//                 mavrykFa12TokenStorage      = await mavrykFa12TokenInstance.storage()
//                 contractAccount             = await mavrykFa12TokenStorage.ledger.get(vestingAddress.address)
//                 userAccount                 = await mavrykFa12TokenStorage.ledger.get(bob.pkh)
//                 const midAccountBalance     = contractAccount ? contractAccount.balance.toNumber() : 0;
...
//                 // Initial values
//                 mavrykFa2TokenStorage       = await mavrykFa2TokenInstance.storage()
//                 var contractAccount         = await mavrykFa2TokenStorage.ledger.get(aggregatorFactoryAddress.address)
//                 var userAccount             = await mavrykFa2TokenStorage.ledger.get(bob.pkh)
//                 const initAccountBalance    = contractAccount ? contractAccount.toNumber() : 0;
//                 const initUserBalance       = userAccount ? userAccount.toNumber() : 0;
//                 const tokenAmount           = 200;
...
//                 // Mid values
//                 mavrykFa2TokenStorage       = await mavrykFa2TokenInstance.storage()
//                 contractAccount             = await mavrykFa2TokenStorage.ledger.get(aggregatorFactoryAddress.address)
//                 userAccount                 = await mavrykFa2TokenStorage.ledger.get(bob.pkh)
//                 const midAccountBalance     = contractAccount ? contractAccount.toNumber() : 0;
...
//                 // Initial values
//                 mavrykFa2TokenStorage       = await mavrykFa2TokenInstance.storage()
//                 var contractAccount         = await mavrykFa2TokenStorage.ledger.get(governanceSatelliteAddress.address)
//                 var userAccount             = await mavrykFa2TokenStorage.ledger.get(bob.pkh)
//                 const initAccountBalance    = contractAccount ? contractAccount.toNumber() : 0;
//                 const initUserBalance       = userAccount ? userAccount.toNumber() : 0;
//                 const tokenAmount           = 200;
...
//                 // Mid values
//                 mavrykFa2TokenStorage       = await mavrykFa2TokenInstance.storage()
//                 contractAccount             = await mavrykFa2TokenStorage.ledger.get(governanceSatelliteAddress.address)
//                 userAccount                 = await mavrykFa2TokenStorage.ledger.get(bob.pkh)
//                 const midAccountBalance     = contractAccount ? contractAccount.toNumber() : 0;
...
//                 // Initial values
//                 mavrykFa2TokenStorage       = await mavrykFa2TokenInstance.storage()
//                 var contractAccount         = await mavrykFa2TokenStorage.ledger.get(mavrykFa12TokenAddress.address)
//                 var userAccount             = await mavrykFa2TokenStorage.ledger.get(bob.pkh)
//                 const initAccountBalance    = contractAccount ? contractAccount.toNumber() : 0;
//                 const initUserBalance       = userAccount ? userAccount.toNumber() : 0;
//                 const tokenAmount           = 200;
...
//                         txs: [
//                             {
//                                 to_: mavrykFa12TokenAddress.address,
//                                 token_id: 0,
//                                 amount: tokenAmount
//                             }
//                         ]
...
//                 // Mid values
//                 mavrykFa2TokenStorage       = await mavrykFa2TokenInstance.storage()
//                 contractAccount             = await mavrykFa2TokenStorage.ledger.get(mavrykFa12TokenAddress.address)
//                 userAccount                 = await mavrykFa2TokenStorage.ledger.get(bob.pkh)
//                 const midAccountBalance     = contractAccount ? contractAccount.toNumber() : 0;
...
//                 // Initial values
//                 mavrykFa2TokenStorage       = await mavrykFa2TokenInstance.storage()
//                 var contractAccount         = await mavrykFa2TokenStorage.ledger.get(mavrykFa2TokenAddress.address)
//                 var userAccount             = await mavrykFa2TokenStorage.ledger.get(bob.pkh)
//                 const initAccountBalance    = contractAccount ? contractAccount.toNumber() : 0;
//                 const initUserBalance       = userAccount ? userAccount.toNumber() : 0;
//                 const tokenAmount           = 200;
...
//                         txs: [
//                             {
//                                 to_: mavrykFa2TokenAddress.address,
//                                 token_id: 0,
//                                 amount: tokenAmount
//                             }
//                         ]
...
//                 // Mid values
//                 mavrykFa2TokenStorage       = await mavrykFa2TokenInstance.storage()
//                 contractAccount             = await mavrykFa2TokenStorage.ledger.get(mavrykFa2TokenAddress.address)
//                 userAccount                 = await mavrykFa2TokenStorage.ledger.get(bob.pkh)
//                 const midAccountBalance     = contractAccount ? contractAccount.toNumber() : 0;
