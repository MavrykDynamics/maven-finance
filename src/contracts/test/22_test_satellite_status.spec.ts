...
describe("Satellite status tests", async () => {
    ...
    describe("AGGREGATOR", async () => {
        ...
        describe("%setObservationCommit", async () => {

            it('Suspended satellite should not be able to set an observation commit', async () => {
                try{
                    // Initial Values
                    await signerFactory(alice.sk);
                    delegationStorage               = await delegationInstance.storage();
                    ...
                    // Operation
                    await chai.expect(aggregatorInstance.methods.setObservationCommit(round, hash).send()).to.be.rejected;
            ...
            it('Banned satellite should not be able to set an observation commit', async () => {
                try{
                    // Initial Values
                    await signerFactory(eve.sk);
                    delegationStorage               = await delegationInstance.storage();
        ...
        describe("%setObservationReveal", async () => {

            before("Wait for two minutes", async () => {
                try{
            ...
            it('Suspended satellite should not be able to set an observation reveal', async () => {
                try{
                    // Initial Values
                    await signerFactory(alice.sk);
                    delegationStorage               = await delegationInstance.storage();
                    ...
                    // Operation
                    await chai.expect(aggregatorInstance.methods.setObservationReveal(round, price, salt, alice.pkh).send()).to.be.rejected;
            ...
            it('Banned satellite should not be able to set an observation reveal', async () => {
                try{
                    // Initial Values
                    await signerFactory(eve.sk);
                    delegationStorage               = await delegationInstance.storage();
                    ...
                    // Operation
                    await chai.expect(aggregatorInstance.methods.setObservationReveal(round, price, salt, eve.pkh).send()).to.be.rejected;
        ...
        describe("%requestRateUpdateDeviation", async () => {

            it('Suspended satellite should not be able to request the rate update deviation', async () => {
                try{
                    // Initial Values
                    await signerFactory(alice.sk);
                    delegationStorage               = await delegationInstance.storage();
            ...
            it('Banned satellite should not be able to request the rate update deviation', async () => {
                try{
                    // Initial Values
                    await signerFactory(eve.sk);
                    delegationStorage               = await delegationInstance.storage();
