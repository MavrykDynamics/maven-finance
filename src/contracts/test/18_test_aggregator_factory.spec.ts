...
//     const deviationTriggerBanDuration: BigNumber = new BigNumber(100);
...
//         assert.deepEqual(storage.config.deviationTriggerBanDuration,deviationTriggerBanDuration);
