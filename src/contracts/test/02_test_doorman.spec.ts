    ...
    describe("%stake", async () => {
        ...
        it("user should be able to stake less than his maximum amount of MVK but at least 1MVK", async() => {
            try{
                ...
                const doormanSMVKTotalSupply = doormanStorage.totalStakedMvkSupply.toNumber();
                ...
                const doormanSMVKTotalSupplyEnd = doormanStorage.totalStakedMvkSupply.toNumber();
    ...
    describe("%unstake", async () => {
        ...
        it("single user should be able to unstake some MVK and earn all the exit fee", async() => {
            try{
                ...
                console.log(`doormanSMVKTotalSupply: ${doormanSMVKTotalSupply}`);
                console.log(`doormanSMVKTotalSupplyEnd: ${doormanSMVKTotalSupplyEnd}`);
                console.log(`doormanSMVKTotalSupplyEnd - expectedFinalAmount: ${doormanSMVKTotalSupplyEnd - expectedFinalAmount}`);
