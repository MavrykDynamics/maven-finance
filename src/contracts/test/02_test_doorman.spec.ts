...
describe("Doorman tests", async () => {
    ...
    //     })
        ...
        //         // Doorman Parameter Schema
        //         const doormanParameterSchema = doormanInstance.parameterSchema.ExtractSchema();
        //         console.log(JSON.stringify(doormanParameterSchema,null,2));

        //         const stakeBytes = await doormanStorage.lambdaLedger.get("stake");
        //         console.log("stake bytes: ");
        //         console.log(stakeBytes);

                // Operation Estimate
                // const operationEstimate = await utils.tezos.estimate.transfer(doormanInstance.methods.callLambda("stake",userStake).toTransferParams());
                // const operationEstimate = await utils.tezos.estimate.transfer(doormanInstance.methods.callLambda("setAdmin",alice.pkh).toTransferParams());
