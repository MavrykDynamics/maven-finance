...
[@inline] const error_CALL_GOVERNANCE_LAMBDA_PROXY_ENTRYPOINT_NOT_FOUND     = 16n;

[@inline] const error_VIEW_GET_TOTAL_SUPPLY_NOT_FOUND                       = 17n;
[@inline] const error_VIEW_GET_ACTIVE_SATELLITES_NOT_FOUND                  = 18n;
[@inline] const error_TRANSFER_ENTRYPOINT_NOT_FOUND                         = 19n;
[@inline] const error_MINT_MVK_AND_TRANSFER_ENTRYPOINT_NOT_FOUND            = 20n;
[@inline] const error_FINANCIAL_REQUEST_SNAPSHOT_NOT_FOUND                  = 21n;

[@inline] const error_LAMBDA_NOT_FOUND                                      = 22n;
[@inline] const error_UNABLE_TO_UNPACK_LAMBDA                               = 23n;
