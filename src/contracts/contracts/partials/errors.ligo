...
[@inline] const error_LENDING_CONTROLLER_CONTRACT_NOT_FOUND                                                             = 818n;

[@inline] const error_ONLY_LENDING_CONTROLLER_CONTRACT_ALLOWED                                                          = 819n;

[@inline] const error_VAULT_ALREADY_EXISTS                                                                              = 820n;
[@inline] const error_VAULT_CONTRACT_NOT_FOUND                                                                          = 821n;
[@inline] const error_VAULT_ID_ALREADY_USED                                                                             = 822n;
[@inline] const error_VAULT_IS_UNDERCOLLATERIZED                                                                        = 823n;
[@inline] const error_TOTAL_SERVICE_LOAN_FEE_CANNOT_BE_GREATER_THAN_BORROWED_AMOUNT                                     = 824n;
[@inline] const error_LOAN_FEE_CANNOT_BE_GREATER_THAN_BORROWED_AMOUNT                                                   = 825n;
[@inline] const error_BORROW_CALLBACK_ENTRYPOINT_IN_TOKEN_POOL_CONTRACT_NOT_FOUND                                       = 826n;
[@inline] const error_REPAY_CALLBACK_ENTRYPOINT_IN_TOKEN_POOL_CONTRACT_NOT_FOUND                                        = 827n;
[@inline] const error_USER_BORROW_INDEX_CANNOT_BE_GREATER_THAN_TOKEN_BORROW_INDEX                                       = 828n;
[@inline] const error_REPAY_CALLBACK_ENTRYPOINT_IN_TOKEN_POOL_CONTRACT_NOT_FOUND                                        = 829n;
[@inline] const error_LOAN_OUTSTANDING_MISCALCULATION                                                                   = 830n;
[@inline] const error_PRINCIPAL_REDUCTION_MISCALCULATION                                                                = 831n;
[@inline] const error_LOAN_INTEREST_MISCALCULATION                                                                      = 832n;
[@inline] const error_LOAN_OUTSTANDING_IS_NOT_ZERO                                                                      = 833n;
[@inline] const error_TRANSFER_ENTRYPOINT_IN_TOKEN_POOL_REWARD_CONTRACT_NOT_FOUND                                       = 834n;
...
[@inline] const error_VAULT_DEPOSIT_STAKED_MVK_ENTRYPOINT_IN_LENDING_CONTROLLER_CONTRACT_PAUSED                         = 847n;
[@inline] const error_VAULT_WITHDRAW_STAKED_MVK_ENTRYPOINT_IN_LENDING_CONTROLLER_CONTRACT_PAUSED                        = 848n;
[@inline] const error_VAULT_LIQUIDATE_STAKED_MVK_ENTRYPOINT_IN_LENDING_CONTROLLER_CONTRACT_PAUSED                       = 849n;
...
[@inline] const error_GET_VAULT_OPT_VIEW_IN_LENDING_CONTROLLER_CONTRACT_NOT_FOUND                                       = 860n;

[@inline] const error_MINIMUM_LOAN_FEE_TREASURY_SHARE_CANNOT_BE_GREATER_THAN_MINIMUM_LOAN_FEE                           = 861n;
[@inline] const error_INTEREST_TREASURY_SHARE_CANNOT_BE_GREATER_THAN_INTEREST_ACCRUED                                   = 862n;
[@inline] const error_INTEREST_TREASURY_SHARE_CANNOT_BE_GREATER_THAN_TOTAL_INTEREST_PAID                                = 863n;
[@inline] const error_LOAN_TOKEN_ALREADY_EXISTS                                                                         = 864n;
[@inline] const error_LOAN_TOKEN_RECORD_NOT_FOUND                                                                       = 865n;
[@inline] const error_LOAN_TOKEN_LEDGER_NOT_FOUND                                                                       = 866n;
[@inline] const error_LOAN_TOKEN_RECORD_ALREADY_EXISTS                                                                  = 867n;
[@inline] const error_COLLATERAL_TOKEN_RECORD_NOT_FOUND                                                                 = 868n;
[@inline] const error_COLLATERAL_TOKEN_ALREADY_EXISTS                                                                   = 869n;
[@inline] const error_SENDER_MUST_BE_VAULT_ADDRESS                                                                      = 870n;

[@inline] const error_INSUFFICIENT_COLLATERAL_TOKEN_BALANCE_IN_VAULT                                                    = 871n;
[@inline] const error_CANNOT_WITHDRAW_MORE_THAN_TOTAL_COLLATERAL_BALANCE                                                = 872n;
[@inline] const error_CANNOT_WITHDRAW_AS_VAULT_IS_UNDERCOLLATERIZED                                                     = 873n;

[@inline] const error_VAULT_IS_NOT_UNDERCOLLATERIZED                                                                    = 874n;
[@inline] const error_VAULT_IS_NOT_LIQUIDATABLE                                                                         = 875n;
[@inline] const error_VAULT_HAS_ALREADY_BEEN_MARKED_FOR_LIQUIDATION                                                     = 876n;
[@inline] const error_VAULT_IS_NOT_READY_TO_BE_LIQUIDATED                                                               = 877n;

[@inline] const error_OWNER_VAULT_SET_DOES_NOT_EXIST                                                                    = 878n;

[@inline] const error_GET_COL_TOKEN_RECORD_BY_ADDRESS_OPT_VIEW_NOT_FOUND                                                = 879n;
[@inline] const error_GET_COL_TOKEN_RECORD_BY_NAME_OPT_VIEW_NOT_FOUND                                                   = 880n;

[@inline] const error_CANNOT_BURN_MORE_THAN_TOTAL_AMOUNT_OF_LP_TOKENS                                                   = 881n;
[@inline] const error_TOKEN_POOL_TOTAL_CANNOT_BE_NEGATIVE                                                               = 882n;
[@inline] const error_TOKEN_POOL_REMAINING_CANNOT_BE_NEGATIVE                                                           = 883n;

[@inline] const error_TEZOS_SENT_IS_NOT_EQUAL_TO_WITHDRAW_AMOUNT                                                        = 884n;

[@inline] const error_CANNOT_LIQUIDATE_MORE_THAN_TOTAL_COLLATERAL_BALANCE                                               = 885n;

[@inline] const error_TOO_MANY_DECIMAL_PLACES_FOR_CALCULATION                                                           = 886n;
[@inline] const error_REBASE_DECIMALS_OUT_OF_BOUNDS                                                                     = 887n;

[@inline] const error_CANNOT_LIQUIDATE_MORE_THAN_VAULT_LOAN_OUTSTANDING_TOTAL                                           = 888n;
[@inline] const error_CANNOT_LIQUIDATE_MORE_THAN_TOKEN_COLLATERAL_BALANCE                                               = 889n;

[@inline] const error_INITIAL_LOAN_PRINCIPAL_TOTAL_CANNOT_BE_GREATER_THAN_LOAN_OUTSTANDING_TOTAL                        = 890n;

[@inline] const error_CANNOT_REMOVE_MORE_LIQUIDITY_THAN_BALANCE                                                         = 891n;
[@inline] const error_MINT_OR_BURN_ENTRYPOINT_IN_LP_TOKEN_NOT_FOUND                                                     = 892n;
[@inline] const error_BREAK_GLASS_CONFIG_NOT_FOUND_IN_LENDING_CONTROLLER                                                = 893n;

[@inline] const error_GET_LOAN_TOKEN_RECORD_OPT_VIEW_IN_LENDING_CONTROLLER_CONTRACT_NOT_FOUND                           = 894n;
[@inline] const error_GET_TOKEN_POOL_DEPOSITOR_BALANCE_OPT_VIEW_IN_LENDING_CONTROLLER_CONTRACT_NOT_FOUND                = 895n;

[@inline] const error_MIN_REPAYMENT_AMOUNT_NOT_REACHED                                                                  = 896n;
[@inline] const error_CANNOT_REGISTER_DEPOSIT_FOR_STAKED_MVK                                                            = 897n;
[@inline] const error_CANNOT_REGISTER_WITHDRAWAL_FOR_STAKED_MVK                                                         = 898n;
