...
function verifySenderIsAdminOrGovernanceProxyNode(var s : aggregatorStorageType) : unit is
block{
...
function calculateSatelliteVotingPower(const satelliteAddress : address; const s : aggregatorStorageType) : nat is
block {
