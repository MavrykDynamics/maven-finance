...
function getStakedMvkTotalSupply(const s : governanceFinancialStorageType) : nat is 
block {
...
function getLambdaBytes(const lambdaKey : string; const s : governanceFinancialStorageType) : bytes is 
block {
