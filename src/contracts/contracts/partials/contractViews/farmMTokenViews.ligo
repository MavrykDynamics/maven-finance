...
[@view] function getWhitelistContracts(const _ : unit; const s: farmMTokenStorageType) : whitelistContractsType is
    s.whitelistContracts



(*  View: get general contracts *)
[@view] function getGeneralContracts(const _ : unit; const s: farmMTokenStorageType) : generalContractsType is
    s.generalContracts
...
[@view] function getLambdaLedger(const _ : unit; const s : farmMTokenStorageType) : lambdaLedgerType is
    s.lambdaLedger
