...
(*  setAdmin lambda *)
function lambdaSetAdmin(const newAdminAddress : address; var s : councilStorage) : return is
block {
...
function lambdaUpdateMetadata(const metadataKey: string; const metadataHash: bytes; var s : councilStorage) : return is
block {
...
(*  updateConfig lambda  *)
function lambdaUpdateConfig(const updateConfigParams : councilUpdateConfigParamsType; var s : councilStorage) : return is 
block {
...
function lambdaUpdateWhitelistContracts(const updateWhitelistContractsParams: updateWhitelistContractsParams; var s: councilStorage): return is
block {
...
function lambdaUpdateGeneralContracts(const updateGeneralContractsParams: updateGeneralContractsParams; var s: councilStorage): return is
block {
...
function lambdaCouncilActionAddMember(const newCouncilMember : councilActionAddMemberType ; var s : councilStorage) : return is 
block {
...
function lambdaCouncilActionRemoveMember(const councilMemberAddress : address ; var s : councilStorage) : return is 
block {
...
function lambdaCouncilActionChangeMember(const councilActionChangeMemberParams : councilActionChangeMemberType; var s : councilStorage) : return is 
block {
...
function lambdaCouncilActionUpdateBlocksPerMinute(const councilActionUpdateBlocksPerMinParam : councilActionUpdateBlocksPerMinType ; var s : councilStorage) : return is 
block {
...
function lambdaCouncilActionRemoveVestee(const vesteeAddress : address ; var s : councilStorage) : return is 
block {
...
function lambdaCouncilActionToggleVesteeLock(const vesteeAddress : address ; var s : councilStorage) : return is 
block {
...
function lambdaCouncilActionTransfer(const councilActionTransferParams : councilActionTransferType; var s : councilStorage) : return is 
block {
...
function lambdaCouncilActionRequestTokens(const councilActionRequestTokensParams : councilActionRequestTokensType ; var s : councilStorage) : return is 
block {
...
function lambdaCouncilActionRequestMint(const councilActionRequestMintParams : councilActionRequestMintType ; var s : councilStorage) : return is 
block {
...
function lambdaCouncilActionDropFinancialRequest(const requestID : nat ; var s : councilStorage) : return is 
block {
...
(*  flushAction lambda  *)
function lambdaFlushAction(const actionId: flushActionType; var s : councilStorage) : return is 
block {
...
(*  signAction lambda  *)
function lambdaSignAction(const actionId: nat; var s : councilStorage) : return is 
block {
