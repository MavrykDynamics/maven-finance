...
(*  breakGlass lambda *)
function lambdaBreakGlass(var s : governanceStorage) : return is 
block {
...
(*  setAdmin lambda *)
function lambdaSetAdmin(const newAdminAddress : address; var s : governanceStorage) : return is
block {
...
function lambdaUpdateMetadata(const metadataKey: string; const metadataHash: bytes; var s : governanceStorage) : return is
block {
...
(*  updateConfig lambda *)
function lambdaUpdateConfig(const updateConfigParams : governanceUpdateConfigParamsType; var s : governanceStorage) : return is 
block {
...
function lambdaUpdateWhitelistContracts(const updateWhitelistContractsParams: updateWhitelistContractsParams; var s: governanceStorage): return is
block {
...
function lambdaUpdateGeneralContracts(const updateGeneralContractsParams: updateGeneralContractsParams; var s: governanceStorage): return is
block {
...
function lambdaUpdateWhitelistTokenContracts(const updateWhitelistTokenContractsParams: updateWhitelistTokenContractsParams; var s: governanceStorage): return is
block {
...
function lambdaStartNextRound(const executePastProposal: bool; var s : governanceStorage) : return is
block {
...
(* propose lambda *)
function lambdaPropose(const newProposal : newProposalType ; var s : governanceStorage) : return is 
block {
...
function lambdaAddUpdateProposalData(const proposalData : addUpdateProposalDataType; var s : governanceStorage) : return is 
block {
...
function lambdaAddUpdatePaymentData(const paymentData : addUpdatePaymentDataType; var s : governanceStorage) : return is 
block {
...
(* lockProposal lambda *)
function lambdaLockProposal(const proposalId : nat; var s : governanceStorage) : return is 
block {
...
function lambdaProposalRoundVote(const proposalId : nat; var s : governanceStorage) : return is 
block {
...
function lambdaVotingRoundVote(const voteType : voteForProposalChoiceType; var s : governanceStorage) : return is 
block {
...
function lambdaExecuteProposal(var s : governanceStorage) : return is 
block {
    // Steps Overview: 
...
(* dropProposal lambda *)
function lambdaDropProposal(const proposalId : nat; var s : governanceStorage) : return is 
block {
