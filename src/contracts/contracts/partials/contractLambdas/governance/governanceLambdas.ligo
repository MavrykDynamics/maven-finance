...
block {
    ...
    case governanceLambdaAction of [
        |   LambdaPropose(newProposal) -> {
                ...
                // Get total number of proposals from satellite for current cycle
                var satelliteProposals : set(nat) := case s.currentCycleInfo.roundProposers[Tezos.sender] of [
                ...
                s.currentCycleInfo.roundProposers[Tezos.sender] := satelliteProposals;
