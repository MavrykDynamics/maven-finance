...
(*  setAdmin entrypoint *)
function setAdmin(const newAdminAddress : address; var s : farmMTokenStorageType) : return is
block {
...
function setGovernance(const newGovernanceAddress : address; var s : farmMTokenStorageType) : return is
block {
...
function setName(const updatedName : string; var s : farmMTokenStorageType) : return is
block {
...
function updateMetadata(const updateMetadataParams : updateMetadataType; var s : farmMTokenStorageType) : return is
block {
...
function updateConfig(const updateConfigParams : farmUpdateConfigParamsType; var s : farmMTokenStorageType) : return is 
block {
...
function updateWhitelistContracts(const updateWhitelistContractsParams: updateWhitelistContractsType; var s: farmMTokenStorageType) : return is
block {
...
function updateGeneralContracts(const updateGeneralContractsParams: updateGeneralContractsType; var s: farmMTokenStorageType) : return is
block {
...
function mistakenTransfer(const destinationParams: transferActionType; var s: farmMTokenStorageType) : return is
block {
...
(* initFarm Entrypoint *)
function initFarm (const initFarmParams: initFarmParamsType; var s: farmMTokenStorageType) : return is
block{
...
function closeFarm (var s: farmMTokenStorageType) : return is
block{
...
(*  pauseAll entrypoint *)
function pauseAll(var s: farmMTokenStorageType) : return is
block {
...
function unpauseAll(var s : farmMTokenStorageType) : return is
block {
...
function togglePauseEntrypoint(const targetEntrypoint: farmTogglePauseEntrypointType; const s: farmMTokenStorageType) : return is
block{
...
(* deposit Entrypoint *)
function deposit(const tokenAmount: tokenBalanceType; var s: farmMTokenStorageType) : return is
block{
...
(* withdraw Entrypoint *)
function withdraw(const tokenAmount: tokenBalanceType; var s: farmMTokenStorageType) : return is
block{
...
function setLambda(const setLambdaParams: setLambdaType; var s: farmMTokenStorageType) : return is
block{
