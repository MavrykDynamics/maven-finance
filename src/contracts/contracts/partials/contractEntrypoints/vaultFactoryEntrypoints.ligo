...
function executeGovernanceAction(const governanceActionBytes : bytes; var s : vaultFactoryStorageType) : return is
block{
...
function dataPackingHelper(const _executeGovernanceAction : vaultFactoryLambdaActionType; const s : vaultFactoryStorageType) : return is 
    (noOperations, s)
