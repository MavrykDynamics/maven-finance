...
function executeGovernanceAction(const governanceActionBytes : bytes; var s : treasuryStorageType) : return is
block{
...
function dataPackingHelper(const _executeGovernanceAction : treasuryLambdaActionType; const s : treasuryStorageType) : return is 
    (noOperations, s)
