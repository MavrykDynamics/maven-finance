...
block{
    ...
    // get lambda bytes
    const lambdaBytes : bytes = getLambdaBytes("lambdaCreateTreasury", s);
...
block{
    ...
    // get lambda bytes
    const lambdaBytes : bytes = getLambdaBytes("lambdaTrackTreasury", s);
...
block{
    ...
    // get lambda bytes
    const lambdaBytes : bytes = getLambdaBytes("lambdaUntrackTreasury", s);
