...
metadata.set("", web3.utils.asciiToHex("sha256://0x19faf07472cc91927ff455a82c0d51a682164b3b18125e6a5b1763a14f09a60c/https:%2F%2Fmavryk.io%2Fmetadata%2Fcontract_metadata.json").slice(2));
...
// );
// token_info.set(
//     "name", web3.utils.asciiToHex("mavryk").slice(2)
// );
// token_info.set(
//     "decimals", web3.utils.asciiToHex("0").slice(2)
// );
// token_info.set(
//     "thumbnailUri", web3.utils.asciiToHex("https://mavryk.io/logo512.png").slice(2)
// );
...
module.exports = async (deployer, _network, accounts) => {
    deployer.deploy(mavryk, initial_storage, { last_completed_migration: 0, owner: accounts[0] });
};
