export const USER_SATELLITE_INFO_QUERY = `
  query GetUserSatelliteInfo ($_eq: String = "") {
...
export const USER_SATELLITE_INFO_QUERY_NAME = 'GetUserSatelliteInfo'

export function USER_SATELLITE_INFO_QUERY_VARIABLES(address: string): Record<string, any> {
  /* prettier-ignore */
  return { _eq: address }
}
