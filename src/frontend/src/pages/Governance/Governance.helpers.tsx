...
export const normalizeGovernanceStorage = (storage: GovernanceStorageGraphQL | null) => {
  ...
  return {
    ...
    config: {
      ...
      proposalDescriptionMaxLength: currentGovernance?.proposal_description_max_length,
      proposalInvoiceMaxLength: currentGovernance?.proposal_invoice_max_length,
      proposalMetadataTitleMaxLength: currentGovernance?.proposal_metadata_title_max_length,
      proposalSourceCodeMaxLength: currentGovernance?.proposal_source_code_max_length,
      proposalTitleMaxLength: currentGovernance?.proposal_title_max_length,
    },
