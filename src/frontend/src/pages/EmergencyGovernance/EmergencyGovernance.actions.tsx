...
export const GET_EMERGENCY_GOVERNANCE_STORAGE =
  "GET_EMERGENCY_GOVERNANCE_STORAGE";
export const SET_EMERGENCY_GOVERNANCE_ACTIVE =
  "SET_EMERGENCY_GOVERNANCE_ACTIVE";
export const SET_HAS_ACKNOWLEDGED_EMERGENCY_GOV =
...
export const getEmergencyGovernanceStorage =
  (accountPkh?: string) => async (dispatch: any, getState: any) => {
    ...
    const emergencyGovernanceStorage = normalizeEmergencyGovernance(
      storage?.emergency_governance[0]
    );
...
export const SUBMIT_EMERGENCY_GOVERNANCE_PROPOSAL_REQUEST =
  "SUBMIT_EMERGENCY_GOVERNANCE_PROPOSAL_REQUEST";
export const SUBMIT_EMERGENCY_GOVERNANCE_PROPOSAL_RESULT =
  "SUBMIT_EMERGENCY_GOVERNANCE_PROPOSAL_RESULT";
export const SUBMIT_EMERGENCY_GOVERNANCE_PROPOSAL_ERROR =
  ...
  (form: any, accountPkh?: string) => async (dispatch: any, getState: any) => {
    ...
    try {
      ...
      const contract = await state.wallet.tezos?.wallet.at(
        state.contractAddresses.emergencyGovernanceAddress.address
      );
      console.log("contract", contract);
      const triggerFee =
        state.emergencyGovernance.emergencyGovernanceStorage.config
          .requiredFeeMutez || 0;
      ...
      dispatch(
        showToaster(INFO, "Submitting emergency proposal...", "Please wait 30s")
      );
      dispatch({
      ...
      dispatch(
        showToaster(SUCCESS, "Emergency Proposal Submitted", "All good :)")
      );
