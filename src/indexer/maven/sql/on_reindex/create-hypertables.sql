...
BEGIN
    IF EXISTS (SELECT 1 FROM pg_proc
               WHERE proname = 'create_hypertable') THEN
        -- Safe to call create_hypertable
        RAISE NOTICE 'create_hypertable exists, can be called.';
        ...
        IF NOT EXISTS (SELECT 1 FROM timescaledb_information.hypertables 
            ...
            RAISE NOTICE 'Creating hypertable for aggregator_oracle_observation...';
            ...
            SELECT create_hypertable('aggregator_oracle_observation', 'timestamp');
        ELSE
        ...
        IF NOT EXISTS (SELECT 1 FROM timescaledb_information.hypertables 
            ...
            RAISE NOTICE 'Creating hypertable for aggregator_history_data...';
        ...
        IF NOT EXISTS (SELECT 1 FROM timescaledb_information.hypertables 
            ...
            RAISE NOTICE 'Creating hypertable for dipdup_exception...';
        ...
        IF NOT EXISTS (SELECT 1 FROM timescaledb_information.hypertables 
            ...
            RAISE NOTICE 'Creating hypertable for stake_history_data...';
            ...
            SELECT create_hypertable('stake_history_data', 'timestamp');
        ELSE
        ...
        IF NOT EXISTS (SELECT 1 FROM timescaledb_information.hypertables 
            ...
            RAISE NOTICE 'Creating hypertable for smvn_history_data...';
        ...
        IF NOT EXISTS (SELECT 1 FROM timescaledb_information.hypertables 
            ...
            RAISE NOTICE 'Creating hypertable for emergency_governance_vote...';
            ...
            SELECT create_hypertable('emergency_governance_vote', 'timestamp');
        ELSE
        ...
        IF NOT EXISTS (SELECT 1 FROM timescaledb_information.hypertables 
            ...
            RAISE NOTICE 'Creating hypertable for governance_financial_request_vote...';
            ...
            SELECT create_hypertable('governance_financial_request_vote', 'timestamp');
        ELSE
        ...
        IF NOT EXISTS (SELECT 1 FROM timescaledb_information.hypertables 
            ...
            RAISE NOTICE 'Creating hypertable for governance_satellite_action_vote...';
            ...
            SELECT create_hypertable('governance_satellite_action_vote', 'timestamp');
        ELSE
        ...
        IF NOT EXISTS (SELECT 1 FROM timescaledb_information.hypertables 
            ...
            RAISE NOTICE 'Creating hypertable for governance_proposal_vote...';
            ...
            SELECT create_hypertable('governance_proposal_vote', 'timestamp');
        ELSE
        ...
        IF NOT EXISTS (SELECT 1 FROM timescaledb_information.hypertables 
            ...
            RAISE NOTICE 'Creating hypertable for lending_controller_history_data...';
        ...
        IF NOT EXISTS (SELECT 1 FROM timescaledb_information.hypertables 
            ...
            RAISE NOTICE 'Creating hypertable for m_token_account_history_data...';
        ...
        IF NOT EXISTS (SELECT 1 FROM timescaledb_information.hypertables 
            ...
            RAISE NOTICE 'Creating hypertable for mvn_transfer_history_data...';
        ...
        IF NOT EXISTS (SELECT 1 FROM timescaledb_information.hypertables 
            ...
            RAISE NOTICE 'Creating hypertable for treasury_transfer_history_data...';
    ...
    ELSE
        RAISE NOTICE 'create_hypertable does not exist, skipping.';
    END IF;
END $$;
