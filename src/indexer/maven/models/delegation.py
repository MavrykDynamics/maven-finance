...
from maven.models.enums import SatelliteStatus

###
# Delegation Tables
###

class Delegation(MavenContract, Model):
    governance                              = fields.ForeignKeyField('models.Governance', related_name='delegations')
    minimum_smvn_balance                    = fields.FloatField(default=0)
...
class SatelliteRewards(Model):
    ...
    user                                    = fields.ForeignKeyField('models.MavenUser', related_name='satellite_rewardss')
