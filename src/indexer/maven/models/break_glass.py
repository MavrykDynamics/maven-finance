...
class BreakGlass(MavenContract, Model):
...
class BreakGlassAction(Model):
    ...
    initiator                               = fields.ForeignKeyField('models.MavenUser', related_name='break_glass_actions_initiator', index=True)
...
class BreakGlassActionSigner(Model):
    ...
    signer                                  = fields.ForeignKeyField('models.MavenUser', related_name='break_glass_action_signers', index=True)
