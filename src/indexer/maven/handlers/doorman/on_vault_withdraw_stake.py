...
async def on_vault_withdraw_stake(
    ...
    try:
        ...
        # Vault
        vault                           = await models.get_user(network=models.NETWORK, address=vault_address)
        ...
        # Get doorman info
        doorman_user        = await models.get_user(network=models.NETWORK, address=doorman_address)
