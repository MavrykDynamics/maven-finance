    ...
    try:
        ...
        if action_type == "addCouncilMember":
            for council_member_address in council_members:
                ...
                member_user             = await models.get_user(network=models.NETWORK, address=council_member_address)
            ...
            old_council_member_user         = await models.get_user(network=models.NETWORK, address=old_council_member_address)
        ...
        user                    = await models.get_user(network=models.NETWORK, address=signer_address)
