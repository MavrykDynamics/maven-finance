...
async def on_doorman_toggle_pause_unstake(
    ...
    # Update doorman
    doorman.stake_paused        = toggle_pause_unstake.storage.breakGlassConfig.stakeIsPaused
    doorman.unstake_paused      = toggle_pause_unstake.storage.breakGlassConfig.unstakeIsPaused
    doorman.compound_paused     = toggle_pause_unstake.storage.breakGlassConfig.compoundIsPaused
    doorman.farm_claim_paused   = toggle_pause_unstake.storage.breakGlassConfig.farmClaimIsPaused
    await doorman.save()
