...
from mavryk.types.lending_controller_mock_time.parameter.borrow import BorrowParameter
from dipdup.models import Transaction
from dipdup.context import HandlerContext
import mavryk.models as models
from dateutil import parser

async def on_lending_controller_mock_time_borrow(
    ctx: HandlerContext,
    borrow: Transaction[BorrowParameter, LendingControllerMockTimeStorage],
) -> None:
