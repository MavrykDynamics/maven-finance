...
async def on_lending_controller_pause_all(
    ...
    update_collateral_token_paused          = pause_all.storage.breakGlassConfig.updateCollateralTokenIsPaused
    vault_deposit_smvk_paused               = pause_all.storage.breakGlassConfig.vaultDepositStakedMvkIsPaused
    vault_withdraw_smvk_paused              = pause_all.storage.breakGlassConfig.vaultWithdrawStakedMvkIsPaused
    vault_liquidate_smvk_paused             = pause_all.storage.breakGlassConfig.vaultLiquidateStakedMvkIsPaused
