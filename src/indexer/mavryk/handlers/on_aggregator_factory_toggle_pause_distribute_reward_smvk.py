...
async def on_aggregator_factory_toggle_pause_distribute_reward_smvk(
    ...
    # Get operation info
    aggregator_factory_address                          = toggle_pause_distribute_reward_s_mvk.data.target_address
    create_aggregator_paused                            = toggle_pause_distribute_reward_s_mvk.storage.breakGlassConfig.createAggregatorIsPaused
