...
async def withdraw_stake(
    ...
    try:
        # Get operation info
        timestamp                                   = withdraw_stake.data.timestamp
        doorman_address                             = withdraw_stake.data.target_address
        vault_owner_address                         = withdraw_stake.parameter.vaultOwner
        vault_owner_stake_balance_ledger            = withdraw_stake.storage.userStakeBalanceLedger[vault_owner_address]
        ...
        vault_address                               = withdraw_stake.parameter.vaultAddress
        vault_stake_balance_ledger                  = withdraw_stake.storage.userStakeBalanceLedger[vault_address]
        ...
        unclaimed_rewards                           = float(withdraw_stake.storage.unclaimedRewards)
        accumulated_fees_per_share                  = float(withdraw_stake.storage.accumulatedFeesPerShare)
