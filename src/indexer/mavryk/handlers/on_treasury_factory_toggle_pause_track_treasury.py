...
async def on_treasury_factory_toggle_pause_track_treasury(
    ...
    # Get operation info
    treasury_factory_address    = toggle_pause_track_treasury.data.target_address
    treasury_factory            = await models.TreasuryFactory.get(address=treasury_factory_address)

    # Update record
    treasury_factory.create_treasury_paused     = toggle_pause_track_treasury.storage.breakGlassConfig.createTreasuryIsPaused
    treasury_factory.track_treasury_paused      = toggle_pause_track_treasury.storage.breakGlassConfig.trackTreasuryIsPaused
    treasury_factory.untrack_treasury_paused    = toggle_pause_track_treasury.storage.breakGlassConfig.untrackTreasuryIsPaused
