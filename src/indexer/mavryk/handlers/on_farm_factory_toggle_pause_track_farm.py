...
async def on_farm_factory_toggle_pause_track_farm(
    ...
    # Get operation info
    farm_factory_address    = toggle_pause_track_farm.data.target_address
    farm_factory            = await models.FarmFactory.get(address=farm_factory_address)

    # Update record
    farm_factory.create_farm_paused     = toggle_pause_track_farm.storage.breakGlassConfig.createFarmIsPaused
    farm_factory.track_farm_paused      = toggle_pause_track_farm.storage.breakGlassConfig.trackFarmIsPaused
    farm_factory.untrack_farm_paused    = toggle_pause_track_farm.storage.breakGlassConfig.untrackFarmIsPaused
