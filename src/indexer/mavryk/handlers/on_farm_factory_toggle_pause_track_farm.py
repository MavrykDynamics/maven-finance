...
async def on_farm_factory_toggle_pause_track_farm(
    ...
    # Get farm contract
    farmFactoryAddress = toggle_pause_track_farm.data.target_address
    farmFactory = await models.FarmFactory.get(address=farmFactoryAddress)

    # Update farm factory
    farmFactory.create_farm_paused = toggle_pause_track_farm.data.storage['breakGlassConfig']['createFarmIsPaused']
    farmFactory.track_farm_paused = toggle_pause_track_farm.data.storage['breakGlassConfig']['trackFarmIsPaused']
    farmFactory.untrack_farm_paused = toggle_pause_track_farm.data.storage['breakGlassConfig']['untrackFarmIsPaused']
