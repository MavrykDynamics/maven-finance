...
from mavryk.types.lending_controller_mock_time.parameter.vault_deposit_staked_mvk import VaultDepositStakedMvkParameter
...
async def on_lending_controller_mock_time_vault_deposit_staked_mvk(
    ctx: HandlerContext,
    vault_deposit_staked_mvk: Transaction[VaultDepositStakedMvkParameter, LendingControllerMockTimeStorage],
) -> None:
