...
async def on_doorman_unpause_all(
    ...
    # Update doorman
    doorman.stake_paused = unpause_all.data.storage['breakGlassConfig']['stakeIsPaused']
    doorman.unstake_paused = unpause_all.data.storage['breakGlassConfig']['unstakeIsPaused']
    doorman.compound_paused = unpause_all.data.storage['breakGlassConfig']['compoundIsPaused']
    await doorman.save()
