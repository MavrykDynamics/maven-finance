...
async def on_lending_controller_mock_time_register_withdrawal(
    ctx: HandlerContext,
    register_withdrawal: Transaction[RegisterWithdrawalParameter, LendingControllerMockTimeStorage],
) -> None:
