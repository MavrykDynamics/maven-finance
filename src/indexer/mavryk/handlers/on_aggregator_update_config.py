...
from mavryk.types.aggregator.parameter.update_config import UpdateConfigParameter, UpdateConfigActionItem as configDecimals, UpdateConfigActionItem1 as configDevTriggerBanDuration, UpdateConfigActionItem2 as configHeartBeatSeconds, UpdateConfigActionItem3 as configPercentOracleThreshold, UpdateConfigActionItem4 as configRewardAmountStakedMvk, UpdateConfigActionItem5 as configRewardAmountXtz
