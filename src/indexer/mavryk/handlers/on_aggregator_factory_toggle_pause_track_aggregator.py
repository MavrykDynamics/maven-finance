...
async def on_aggregator_factory_toggle_pause_track_aggregator(
    ...
    # Get operation info
    aggregator_factory_address                          = toggle_pause_track_aggregator.data.target_address
    create_aggregator_paused                            = toggle_pause_track_aggregator.storage.breakGlassConfig.createAggregatorIsPaused
    track_aggregator_paused                             = toggle_pause_track_aggregator.storage.breakGlassConfig.trackAggregatorIsPaused
    untrack_aggregator_paused                           = toggle_pause_track_aggregator.storage.breakGlassConfig.untrackAggregatorIsPaused
    distribute_reward_xtz_paused                        = toggle_pause_track_aggregator.storage.breakGlassConfig.distributeRewardXtzIsPaused
    distribute_reward_smvk_paused                       = toggle_pause_track_aggregator.storage.breakGlassConfig.distributeRewardStakedMvkIsPaused
