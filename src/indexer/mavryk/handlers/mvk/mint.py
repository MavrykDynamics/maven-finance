...
from mavryk.types.mvk_token.tezos_parameters.mint import MintParameter
from dipdup.models.tezos_tzkt import TzktTransaction
import mavryk.models as models

async def mint(
    ctx: HandlerContext,
    mint: TzktTransaction[MintParameter, MvkTokenStorage],
) -> None:
    ...
    try:
        ...
        # Get mint account
        user                = await models.mavryk_user_cache.get(network=ctx.datasource.name.replace('tzkt_',''), address=mint_address)
